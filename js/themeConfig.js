...
export const sampleThemes = {
  "dashboard": {
    ...
    "Dark": {
      ...
      "text-color-on-primary": "#1b263b",
      "font-color-primary": "#E0E0E0",
      "font-color-secondary": "#A0A5C0",
      "font-color-muted": "#bbb",
      "font-color-on-primary": "#1b263b",
      "bg-color": "#16213E",
      "surface-background": "rgba(40, 40, 60, 0.75)",
      "card-bg": "rgba(40, 40, 60, 0.75)",
      "card-bg-opacity": "0.75",
      "input-bg": "rgba(40, 40, 60, 0.75)",
      "text-color-on-secondary": "#FFFFFF",
      "text-color-disabled": "#adb5bd",
      "border-color": "rgba(91, 192, 190, 0.2)",
      "border-color-soft": "rgba(91, 192, 190, 0.1)",
      "input-bg-disabled": "#2C3147",
      "input-border-color": "rgba(91, 192, 190, 0.2)",
  ...
  "quest": {
    ...
    "Dark": {
      "bg-primary": "#16213E",
      "bg-secondary": "rgba(40, 40, 60, 0.75)",
      "bg-surface": "rgba(40, 40, 60, 0.75)",
      "accent-primary": "#5BC0BE",
      "accent-secondary": "#7D9D9C",
      "text-primary": "#E0E0E0",
