...
export function initializeSelectors() {
    const selDefs = {
        ...
        goalProgressBar: 'goalProgressBar', goalProgressText: 'goalProgressText',
        engagementProgressBar: 'engagementProgressBar', engagementProgressText: 'engagementProgressText',
        healthProgressBar: 'healthProgressBar', healthProgressText: 'healthProgressText',
