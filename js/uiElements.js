...
export function initializeSelectors() {
    const selDefs = {
        ...
        planSectionProgressBar: 'planSectionProgressBar',
        planSectionStatusList: 'planSectionStatusList',
        planSectionProgressContainer: 'planSectionProgressContainer',
    ...
    for (const key in selDefs) {
        ...
        if (!selectors[key] || (key === 'tabButtons' && selectors[key].length === 0)) {
            const optionalOrDynamic = [
                ...
                'planSectionProgressBar', 'planSectionStatusList', 'planSectionProgressContainer',
