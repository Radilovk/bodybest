...
- **Анализ на изображение** – POST заявка към `/api/analyzeImage` изпраща Base64 снимка към модела `@cf/stabilityai/clip` и връща кратко описание.
...
- `POST /api/analyzeImage` – изпраща изображение към AI и връща текстово описание.
