...
5. За страницата `code.html` можете да променяте още:
   - `--code-link-color` – цвета на връзките;
   - `--code-header-bg` – фона на заглавието;
   - `--code-font-family`, `--code-font-size`, `--code-font-weight` – шрифтовите настройки.
