...
- **KV индекси и страниране** – `/api/listUserKv` приема параметри `cursor` и `limit` и първо използва индекс `${userId}_kv_index` с най-важните записи. Пълното изброяване се прави само при нужда на сегменти и може да е скъпо.
