...
която позволява бързо обновяване на използваните модели.
Токените за достъп до AI услугите се задават като Worker secrets
и не се променят през този интерфейс.
...
> **Важно**: Токените се съхраняват единствено като Worker secrets,
> а в KV се записват само имената на моделите.
