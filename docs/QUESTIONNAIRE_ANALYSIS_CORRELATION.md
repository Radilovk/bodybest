...
### 15. Ниво на спортна активност (`sportActivity`)
- **Тип:** Radio
...
### 17. Сокове и газирани напитки (`drinksSweet`)
- **Тип:** Radio
...
### 23. Методи за компенсация (`compensationMethods`)
- **Тип:** Checkbox
...
### 24. Сравнение с други (`socialComparison`)
- **Тип:** Radio
- **Опции:** Постоянно, Често, Понякога, Рядко, Никога
- **Използване:** Психологически профил
